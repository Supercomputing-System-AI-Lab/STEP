...
class SchedulerInterface(ABC):
    ...
    def update_from_output(
        ...
        final_trace_scores contains any per-request final scores computed
        in the engine core so they can be attached to the outputs returned
    ...
    def mark_stop_reason(
        self, request_ids: Iterable[str], stop_reason: str
    ) -> None:
        """Attach a stop reason to in-flight requests before they are stopped."""
        raise NotImplementedError
