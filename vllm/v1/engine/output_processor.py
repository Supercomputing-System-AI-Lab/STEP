...
class RequestState:
    ...
    def make_request_output(
        ...
        output = self._new_completion_output(
            new_token_ids, finish_reason, stop_reason, final_score
        )
        ...
        return self._new_request_output(
            request_id, outputs, finished, kv_transfer_params, final_score
        )
    ...
    def _new_completion_output(
        ...
        return CompletionOutput(
            ...
            final_score=final_score if finished else None,
        )
...
class OutputProcessor:
    ...
    def process_outputs(
        ...
        for engine_core_output in engine_core_outputs:
            ...
            final_score = engine_core_output.final_score
